...
function index($arr1,$arr2,$arr3){
    ...
    */
    ...
    $get_info="select create_time,Handler_read_key,Handler_read_rnd_next from mysql_status_history where host='${ip}' and dbname='${dbname}' and port=${port} and  create_time >=DATE_FORMAT(SUBDATE(now(),interval 1 day),'%Y-%m-%d')"; 
